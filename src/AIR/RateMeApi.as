...
public class RateMeApi extends EventDispatcher
{
	...
	/** @private */
	public function RateMeApi($main:RateMe, $context:ExtensionContext, $debugMode:Boolean, $appId:String):void
	{
		...
		if(OverrideClass["os"] == OverrideClass["ANDROID"] && appId.indexOf("air.") != 0) appId = "air." + appId;
	...
	public function monitor():void
	{
		...
		{
			_context.call("command", "iOSConfig", _messageUpdate, _appName, _promptForNewVersionIfUserRated, _onlyPromptIfLatestVersion, _appStoreID, _appStoreGenreID, _ratingsURL, _useSKStoreReviewController);
		}
		else
		{
			_context.call("command", "androidConfig", _storeType);
		}
		...
		{
			if(OverrideClass["os"] == OverrideClass["ANDROID"]) NativeApplication.nativeApplication.removeEventListener(Event.ACTIVATE, handleActivate);
		}
	}
	...
	/** @private */
	public function set daysUntilPrompt(a:int):void
	{
		_daysUntilPrompt = a;
	}
	...
	{
		return _launchesUntilPrompt;
	}
	
	/** @private */
	public function set launchesUntilPrompt(a:int):void
	{
		_launchesUntilPrompt = a;
	}
	...
	{
		return _remindPeriod;
	}
	
	/** @private */
	public function set remindPeriod(a:int):void
	{
		_remindPeriod = a;
	}
	...
	/** @private */
	public function set message(a:String):void
	{
		_message = a;
	}
	...
	{
		return _remindBtnLabel;
	}
	
	/** @private */
	public function set remindBtnLabel(a:String):void
	{
		_remindBtnLabel = a;
	}
	...
	{
		return _rateBtnLabel;
	}
	
	/** @private */
	public function set rateBtnLabel(a:String):void
	{
		_rateBtnLabel = a;
	}
	...
	/** @private */
	public function set cancelBtnLabel(a:String):void
	{
		_cancelBtnLabel = a;
	}
	...
	/** @private */
	public function set messageUpdate(a:String):void
	{
		_messageUpdate = a;
	}
	...
	/** @private */
	public function set appName(a:String):void
	{
		_appName = a;
	}
	...
	{
		return _promptForNewVersionIfUserRated;
	}
	
	/** @private */
	public function set promptForNewVersionIfUserRated(a:Boolean):void
	{
		_promptForNewVersionIfUserRated = a;
	}
	...
	{
		return _onlyPromptIfLatestVersion;
	}
	
	/** @private */
	public function set onlyPromptIfLatestVersion(a:Boolean):void
	{
		_onlyPromptIfLatestVersion = a;
	}
	...
	/** @private */
	public function set appStoreID(a:Number):void
	{
		_appStoreID = a;
	}
	...
	{
		return _appStoreGenreID;
	}
	
	/** @private */
	public function set appStoreGenreID(a:Number):void
	{
		_appStoreGenreID = a;
	}
	...
	/** @private */
	public function set ratingsURL(a:String):void
	{
		_ratingsURL = a;
	}
	...
	{
		return _useSKStoreReviewController;
	}
	
	/** @private */
	public function set useSKStoreReviewController(a:Boolean):void
	{
		_useSKStoreReviewController = a;
	}
	...
	/** @private */
	public function set storeType(a:int):void
	{
		_storeType = a;
	}
}
